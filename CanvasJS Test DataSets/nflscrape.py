...
nfl_data = pd.DataFrame(columns=("ActivePlayers", "Pos", "BaseSalary", "SigningBonus", "RosterBonus", "OptionBonus", "WorkoutBonus", "RestrucBonus", "Misc", "DeadCap", "CapHit", "Cap%"))
...
teamcode_map = pd.read_csv("teamcode.csv")

# Join position csv onto main csv
nfl_data = nfl_data.merge(position_map, on = "Pos")
nfl_data = nfl_data.merge(teamcode_map, on = "Team")

# Insert results into Mongodb
nfl_data.to_csv("nflsalarycap2.csv")
